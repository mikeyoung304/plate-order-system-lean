  ...
  useEffect(() => {
    ...
    const drawFrame = () => {
      ...
      if (drawingOptions.isGridVisible) {
        ...
        const startX =
          Math.floor(viewLeft / drawingOptions.gridSize) *
          drawingOptions.gridSize
        const startY =
          Math.floor(viewTop / drawingOptions.gridSize) *
          drawingOptions.gridSize
        const endX =
          Math.ceil(viewRight / drawingOptions.gridSize) *
          drawingOptions.gridSize
        const endY =
          Math.ceil(viewBottom / drawingOptions.gridSize) *
          drawingOptions.gridSize
      ...
      if (selectedTable) {
        ...
        if (table) {
          ...
          const rotationHandleY =
            table.y - rotationHandleLineOffset - rotationHandleRadius
