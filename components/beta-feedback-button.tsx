...
import { MessageSquare, Send, Star, Bug, Lightbulb, Heart, X } from 'lucide-react'
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "Your input helps us build a better product. We'll review it soon.",
        duration: 5000
      })
              ...
              {!selectedType ? (
                ...
                <>
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <div className={`flex items-center gap-2 ${getSelectedOption()?.color}`}>
                      {getSelectedOption()?.icon}
                      <span className="font-medium">{getSelectedOption()?.label}</span>
                    </div>
                  </div>
