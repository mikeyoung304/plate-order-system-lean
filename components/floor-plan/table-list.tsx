      ...
      <CardContent className="p-0 max-h-[300px] overflow-y-auto">
        {tables.length > 0 ? (
            ...
            {tables.map((table) => (
              <div
                ...
                className={cn(
                  ...
                  selectedTable?.id === table.id && "bg-blue-900/20 border-r-2 border-blue-500"
                )}
          ...
          <div className="p-6 text-center text-gray-400">
            ...
            <p className="text-sm">Click the toolbar buttons above to add tables to your floor plan</p>
          </div>
        )}
      </CardContent>
    </Card>
