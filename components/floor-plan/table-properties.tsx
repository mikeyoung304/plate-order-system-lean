...
import { Settings, ChevronRight, Trash2, Copy, Layers } from "lucide-react"
...
export function TableProperties({
  ...
  const getStatusBadge = (status: string | undefined) => {
    switch (status) {
      ...
      case "occupied":
        return <Badge className="bg-red-500/20 text-red-400 border-red-500/30">Occupied</Badge>
      case "reserved":
        return <Badge className="bg-amber-500/20 text-amber-400 border-amber-500/30">Reserved</Badge>
      default:
        ...
        <div className="p-4 border-t border-gray-800">
          {selectedTable ? (
            <div className="space-y-4">
              ...
              {/* Number of Seats */}
              <div className="space-y-2">
                <Label htmlFor="table-seats">Seats ({selectedTable.seats})</Label>
                <Slider
                  id="table-seats"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => onUpdateTable('width', parseInt(e.target.value) || 0)}
                    min={20}
                    max={500}
                    className="bg-gray-800 border-gray-700"
                  />
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => onUpdateTable('height', parseInt(e.target.value) || 0)}
                    min={20}
                    max={500}
                    className="bg-gray-800 border-gray-700"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => onUpdateTable('x', parseInt(e.target.value) || 0)}
                    className="bg-gray-800 border-gray-700"
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => onUpdateTable('y', parseInt(e.target.value) || 0)}
                    className="bg-gray-800 border-gray-700"
                  />
                </div>
              </div>
              ...
              {/* Rotation */}
              <div className="space-y-2">
                <Label htmlFor="table-rotation">Rotation ({Math.round(selectedTable.rotation || 0)}°)</Label>
                <Slider
                  id="table-rotation"
            ...
            <div className="text-center py-6 text-gray-400">
              ...
              <p className="text-sm">Click on a table to view and edit its properties</p>
            </div>
          )}
        </div>
      </CollapsibleContent>
