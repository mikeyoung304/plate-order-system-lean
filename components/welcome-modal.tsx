...
import { X, Mic, Users, ChefHat, Utensils, BarChart3, Star, MessageSquare, ArrowRight, Lightbulb, FlaskConical } from 'lucide-react'
        ...
        <div className="space-y-6">
          <div className="text-center">
            ...
            <p className="text-gray-600 leading-relaxed">
              You're among the first to experience our revolutionary voice-powered restaurant system. 
              This beta gives you early access to cutting-edge features that will transform how restaurants operate.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg p-4 border border-blue-200">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="font-semibold text-sm text-gray-700">Beta Tester Exclusive</span>
            </div>
            <p className="text-sm text-gray-600">
              Your feedback shapes the future of this platform. Every interaction helps us build something amazing.
            </p>
          </div>
        </div>
      )
          ...
          <div className="grid grid-cols-1 gap-4">
            <div className="flex items-start gap-3 p-3 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Just speak naturally - "chicken, pasta, salad" - and watch the magic happen</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 p-3 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Interactive table management with resident recognition and preferences</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 p-3 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Orders sync instantly across all stations with live status updates</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 p-3 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors">
              ...
              <div>
                <h4 className="font-medium text-gray-900">Order Intelligence</h4>
                <p className="text-sm text-gray-600">AI-powered suggestions based on dining patterns and preferences</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="font-semibold text-sm text-blue-800">Pro Tip</span>
            </div>
        ...
        <div className="px-6 pb-6">
          ...
          <div className="mt-4 p-3 bg-gray-50 rounded-lg border border-gray-200">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-sm font-medium text-gray-800">Love it? Have feedback?</span>
            </div>
            <p className="text-xs text-gray-600">
              Your insights are invaluable. Use the feedback button in the app or reach out directly!
            </p>
          </div>
        </div>
      </div>
