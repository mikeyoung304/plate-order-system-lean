...
type KitchenSimpleClientComponentProps = {
  user: {
    id: string
    email?: string
  }
...
export function KitchenSimpleClientComponent({
  user,
  profile,
}: KitchenSimpleClientComponentProps) {
  ...
  const loadKitchenOrders = useCallback(async () => {
    try {
      ...
      console.error('[SimpleKitchen] Loading orders...')
