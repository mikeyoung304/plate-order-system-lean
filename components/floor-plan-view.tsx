  ...
  useEffect(() => {
    ...
    const drawFrame = (time: number) => {
      ...
      tables.forEach(table => {
        ...
        const gradientStart = isHovered
          ? 'rgba(56, 189, 174, 0.4)'
          : 'rgba(13, 148, 136, 0.25)'
        const gradientEnd = isHovered
          ? 'rgba(56, 189, 174, 0.2)'
        ...
        if (table.type === 'circle') {
          ...
          ctx.quadraticCurveTo(
            ...
            table.y,
            table.x + table.width,
            table.y + cornerRadius
          )
          ctx.lineTo(
            table.x + table.width,
            table.y + table.height - cornerRadius
          )
          ctx.quadraticCurveTo(
            table.x + table.width,
            table.y + table.height,
            table.x + table.width - cornerRadius,
            table.y + table.height
          )
        ...
        ctx.font = isHovered
          ? "bold 15px -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif"
        ...
        seatPositions.forEach(position => {
          ...
          const seatStroke = isHovered
            ? 'rgba(56, 189, 174, 0.8)'
            : 'rgba(255, 255, 255, 0.6)'
          seatGradient.addColorStop(
            0,
            isHovered ? 'rgba(56, 189, 174, 0.7)' : 'rgba(255, 255, 255, 0.5)'
          )
          seatGradient.addColorStop(
            1,
            isHovered ? 'rgba(56, 189, 174, 0.4)' : 'rgba(200, 200, 200, 0.3)'
          )
          ...
          <div className='absolute inset-0 flex items-center justify-center'>
            <div className='text-center p-6'>
              ...
              <p className='text-sm text-gray-400 mb-4'>
                Please sign in or check your authentication.
              </p>
